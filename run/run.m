...
addpath(genpath('run'));
    ...
    elseif method == "gm_sgd_batch"
        [x,count,ngs] = run_gradient_method_batch(func+"_sgd", opts);
    elseif method == "agm"
    ...
    elseif method == "agm_sgd_batch"
        [x,count,ngs] = run_accelerated_gradient_method_batch(func + "_sgd",opts);
    ...
    elseif method == "bfgs_sgd_batch"
        [x,count,ngs] = run_bfgs_batch(func+"_sgd",opts);
    elseif method == "lbfgs"
